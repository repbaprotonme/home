...
[
    ...
    {name: "_5cnvctx", mouse: "MENU", guide: "DEFAULT", thumb: "DEFAULT", tap: "MENU", pan: "MENU", swipe: "MENU", draw: "PMENU", wheel: "MENU", drop: "DEFAULT", key: "MENU", press: "DEFAULT", pinch: "DEFAULT", fillwidth: Math.min(520,window.innerWidth)},
		...
		resize: function (context)
       	{
            ...
            if (context.index == 4)
            {
                w = Math.min(_4cnv.width,window.innerWidth);
